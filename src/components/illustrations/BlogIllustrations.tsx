// Distinct editorial illustrations for blog post thumbnails

export function BlogIllustration1() {
  // "Why meeting notes fail in Africa" — broken notepad, Mitra fixing it
  return (
    <svg viewBox="0 0 600 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      {[
        { tag: "Decision", w: 52, line: "Expand to Abuja Q1", col: "#88E788" },
        { tag: "Action", w: 40, line: "Chidi → deck by Fri", col: "#E8A94C" },
        { tag: "Action", w: 40, line: "Amara → Interswitch", col: "#E8A94C" },
        { tag: "Follow-up", w: 56, line: "Draft intro → GTBank", col: "rgba(255,255,255,0.6)" },
      ].map((n, i) => (
        <g key={i}>
...
export function BlogIllustration2() {
  // "Follow-up emails that close deals" — email with speed lines, deal won
  return (
    <svg viewBox="0 0 600 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      {/* Deal won — right card */}
      <rect x="430" y="168" width="140" height="100" rx="12" fill="rgba(136,231,136,0.12)" stroke="rgba(136,231,136,0.4)" strokeWidth="1.5"/>
...
export function BlogIllustration3() {
  // "Why local payments aren't a feature" — ₦ symbol with Africa outline
  return (
    <svg viewBox="0 0 600 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      {/* Currency cards */}
      {[
        { currency: "₦", label: "Naira", country: "Nigeria", x: 60, y: 80 },
        { currency: "GH₵", label: "Cedi", country: "Ghana", x: 220, y: 50 },
        { currency: "KSh", label: "Shilling", country: "Kenya", x: 370, y: 80 },
        { currency: "R", label: "Rand", country: "South Africa", x: 490, y: 60 },
      ].map((c, i) => (
        <g key={i}>
          <rect x={c.x} y={c.y} width={90} height={64} rx="10" fill="rgba(27,20,15,0.1)"/>
